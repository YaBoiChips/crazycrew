...
public class CCFood {
    ...
    public static final FoodProperties GOLDEN_CHEEZE_ITS = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.3F).fast().effect(new MobEffectInstance(MobEffects.REGENERATION, 100, 1), 1.0F).effect(new MobEffectInstance(MobEffects.ABSORPTION, 1000, 0), 1.0F).effect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 1000, 0), 1.0F).alwaysEat().build();
    public static final FoodProperties KETCHUP_CHIPS = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.3F).fast().effect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 200, 2), 1.0F).effect(new MobEffectInstance(MobEffects.CONFUSION, 500, 0), 1.0F).alwaysEat().build();

...
public class Chadwick extends TamableAnimal {

    public Chadwick(EntityType<? extends Chadwick> type, Level world) {
        super(type, world);
    }
    ...
    public InteractionResult mobInteract(Player player, InteractionHand hand) {
        ...
        if (this.level.isClientSide) {
            boolean flag = this.isOwnedBy(player) || this.isTame() || itemstack.is(CCItems.MACARON) && !this.isTame();
            return flag ? InteractionResult.CONSUME : InteractionResult.PASS;
        } else if (itemstack.is(CCItems.MACARON)) {
